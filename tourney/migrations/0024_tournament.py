...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tourney', '0023_delete_tournament'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organizer', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='creator', to='organize.Organization')),
