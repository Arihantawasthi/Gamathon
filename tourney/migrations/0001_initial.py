# Generated by Django 2.2.6 on 2020-02-27 09:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yo', models.SmallIntegerField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Tournament',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.TimeField(blank=True, null=True)),
                ('start_date', models.DateField(blank=True, null=True)),
                ('round_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='round_match', to='tourney.Round')),
                ('solo', models.ManyToManyField(blank=True, related_name='solo_match', to='slingshot.User')),
                ('stage', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='stage_match', to='tourney.Stage')),
                ('team', models.ManyToManyField(blank=True, related_name='team_match', to='slingshot.Team')),
                ('tour', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tourney_match', to='tourney.Tournament')),
            ],
        ),
        migrations.CreateModel(
            name='GameStat',
