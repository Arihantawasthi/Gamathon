        ...
        if tournament.tour_type == 'Squad':    
            ...
            if tournament.entry_fee > 0:
                ...
                data_dict = {
                    ...
                    'WEBSITE':'DEFAULT',
                    'CHANNEL_ID':'WEB',
                    'CALLBACK_URL':f'http://13.126.147.71:8000/handleRegisterRequestUser/{username}/{tour_id}',
                }
    ...
    if request.method == 'POST':
        ...
        if request_type == 'get-players':
            ...
            data_dict = {
                ...
                'WEBSITE':'DEFAULT',
                'CHANNEL_ID':'WEB',
                'CALLBACK_URL':f'http://13.126.147.71:8000/handleRegisterRequestTeam/{team_name}/{tour_id}',
            }
            data_dict['CHECKSUMHASH'] = Checksum.generate_checksum(data_dict, MERCHANT_KEY)
            return render(request, 'wallet/paytm.html', {'data_dict': data_dict})
