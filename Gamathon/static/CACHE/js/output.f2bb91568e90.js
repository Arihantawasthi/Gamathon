const continueBtn=document.querySelector('.continue-btn');const modal=document.querySelector('.bg-wallet-modal');const modalContent=document.querySelector('.wallet-modal-content')
const modalClose=document.querySelector('.wallet-modal-close');const lolo=document.querySelector('.notify-div')
continueBtn.addEventListener('click',()=>{modal.style.display='block';setTimeout(()=>{modalContent.style.transform='translate(0rem, 0rem)'},100)});modalClose.addEventListener('click',()=>{modalContent.style.transform='translate(0rem, -5rem)'
setTimeout(()=>{modal.style.display='none';},100)});;const sideBar=document.querySelector('.sideBar');const mobNav=document.querySelector('.mobNav');const container=document.querySelector('.container');const carousel=document.querySelector('.carousel');const body=document.getElementsByTagName('body');const lowerLogin=document.querySelector('.lower-sec-login');const lowerProfile=document.querySelector('.lower-sec-profile');const session=document.querySelector('#session');const sessionUser=document.querySelector('#sessionUser');const notifyDiv=document.querySelector('.notify-div');const notifyHead=document.querySelector('.notify-heading-content');const notifyMessage=document.querySelector('.notify-message')
