...
try{validate.addEventListener('click',function(){if(sessionState.innerHTML==='True'){validateModal.style.display='block'
...
loginClose.addEventListener('click',()=>{login.style.display='none'})
